              ...
              <div class="box box-primary">
                ...
                <form role="form" action="" method="post">
                   ...
                   <input type="text" class="form-control" value="<?php echo $roww['next_ov_keen'];?>" name="next_ov_keen" placeholder="Enter Next Of Keen Names">
                    ...
                    <div class="input-group">
                     ...
                     <div class="form-group">
                      ...
                      <div class="form-group">
                        <div class="col-sm-12">
                           <input type="text" value="<?php echo $roww['cid'];?>" class="form-control" name="cid" readonly>
                         </div>
                    </div><br><br>
                  ...
                  <div class="box-footer">
                    <button type="submit" name="addClient" class="btn btn-primary"><i class="fa fa-plus"></i><i class="fa fa-user"></i> Edit Customer</button>
                  </div>
                </form>
                <?php
