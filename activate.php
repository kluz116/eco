        ...
        <section class="content">
          <div class="box">
                ...
                <div class="input-group date">
                  ...
                  <input type="text" name="initiate_date" class="form-control pull-right" id="datepicker">
                </div>
                <!-- /.input group -->
              </div>
              <!-- /.form group -->
                   ...
                   <input type="text" value="<?php echo $row['order']?>" name="item_id" class="form-control" readonly><br>
                  <input type="submit" name="initiate" class="btn btn-primary " value="Click To Activate Item">
                  </form>
