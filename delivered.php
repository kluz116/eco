...
if(!isset($_SESSION['username']) && empty($_SESSION['username'])){
  ...
  try{
     ...
     $date =$dbh->prepare("select * from order_item where `order` in (select order_id as id from sales) and disburse_date is not null");
     $date->execute();
      ...
      <div class="content-wrapper">
        ...
        <div class="box">
                <div class="box-header">
                  <h3 class="box-title">List Of All Orders Delivered</h3>
                </div><!-- /.box-header -->
                <div class="box-body">
