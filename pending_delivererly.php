...
if(!isset($_SESSION['username']) && empty($_SESSION['username'])){
  ...
  try{
     ...
     $date =$dbh->prepare("select * from order_item where `order` in (select order_id as id from sales) and disburse_date is null");
     $date->execute();
    ...
    <div class="wrapper">
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          <h1>
            Orders Pending Deliverly
          </h1>
          <ol class="breadcrumb">
            <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
            <li class="active">Orders Pending Deliverly</li>
          </ol>
        </section>
        ...
        <div class="box">
                <div class="box-header">
                  <h3 class="box-title">List Of All Pending Deliverly</h3>
                </div><!-- /.box-header -->
                <div class="box-body">
