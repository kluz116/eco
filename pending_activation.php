...
if(!isset($_SESSION['username']) && empty($_SESSION['username'])){
  ...
  try{
     ...
     $date =$dbh->prepare("select `order` from order_item where `order` in (select order_id as id from sales) and installation_date is null");
     $date->execute();
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          ...
          <ol class="breadcrumb">
            ...
            <li class="active">Pending System Activation</li>
          </ol>
        </section>
        ...
        <div class="box">
                <div class="box-header">
                  <h3 class="box-title">List Of All Pending System Activation</h3>
                </div><!-- /.box-header -->
                <div class="box-body">
